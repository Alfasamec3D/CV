...
\documentclass[a4paper,skipsamekey,11pt,russian]{curve}
...
\DefineBibliographyStrings{russian}{url={\textsc{url}}}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Иван Шаверин}

  \makefield{\faEnvelope[regular]}{\href{mailto:shaverin.ia@phystech.edu}{\texttt{shaverin.ia@phystech.edu}}}
  ...
  \makefield{\faTelegram} {\href{https://t.me/ioanashot}{\texttt{@ioanashot}}}
  %\makefield{\faLinkedin}
  %{\href{http://www.linkedin.com/in/example/}{\texttt{example}}}

  %% Next line
  \makefield{\faGithub}{\url{https://github.com/Alfasamec3D}}
